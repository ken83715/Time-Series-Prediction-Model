...
for n in range(neural_num): #num of neural network
    ...
    if error < besterror:
        bestadd = testadd
        besterror = error
bestadd.savemodel('TDCS/models/b_std_25_add.pkl')
...
for n in range(neural_num): #num of neural network
    ...
    if error < besterror:
        bestadd_h = testadd_h
        besterror = error
bestadd_h.savemodel('TDCS/models/b_std_25_add_h.pkl')
...
plt.title('Random std 2.5 Performance')
...
plt.title('Random std 2.5 with Add Error distribution')
