...
DATASET.get_cleardata_movingavg()
cleardata = DATASET.cleardata

tempmodel_path = 'TDCS/models/base_mov_temp.pkl'
model_path = 'TDCS/models/base_tdcs_mov.pkl'
model_h_path = 'TDCS/models/base_tdcs_mov_h.pkl'
...
plt.title('process_moving_average')
plt.plot(x, y_mov, '--', c='grey', label='act', linewidth=3.0)
...
plt.title('process_moving_average Error distribution')
