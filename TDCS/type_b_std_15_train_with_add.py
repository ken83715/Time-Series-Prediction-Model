...
for n in range(neural_num): #num of neural network
    ...
    if error < besterror:
        bestadd = testadd
        besterror = error
bestadd.savemodel('TDCS/models/b_std_15_add.pkl')
...
for n in range(neural_num): #num of neural network
    ...
    if error < besterror:
        bestadd_h = testadd_h
        besterror = error
bestadd_h.savemodel('TDCS/models/b_std_15_add_h.pkl')
...
plt.title('Random std 1.5 Performance')
...
plt.title('Random std 1.5 with Add Error distribution')
